            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.FlashSale"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/products": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Filter in-stock products only (true)",
                        "name": "in_stock",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Sort by: price_asc, price_desc, rating, newest",
                        "name": "sort_by",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/promotion.ValidateCouponRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "domain.FlashSale": {
            ...
            "properties": {
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.FlashSaleItem"
                    }
                },
                "starts_at": {
                    "type": "string"
        ...
        "domain.Promotion": {
            ...
            "properties": {
                ...
                "discount_type": {
                    "description": "\"fixed\" หรือ \"percentage\"",
                    "type": "string"
                },
                "discount_value": {
                    "description": "เช่น 100 บาท หรือ 15%",
                    "type": "number"
                },
                "expires_at": {
                    "type": "string"
                ...
                "max_discount": {
                    "description": "เพดานลดสูงสุด (กรณีคิดเป็น %)",
                    "type": "number"
                },
                "min_spend": {
                    "description": "ยอดซื้อขั้นต่ำ",
                    "type": "number"
                },
                "starts_at": {
                    "type": "string"
        ...
        "promotion.ValidateCouponRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
